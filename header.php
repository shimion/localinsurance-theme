...
(function(a,e,c,f,g,b,d){var h={ak:"1067420895",cl:"6RqTCNSo3VYQ35n-_AM"};a[c]=a[c]||function(){(a[c].q=a[c].q||[]).push(arguments)};a[f]||(a[f]=h.ak);b=e.createElement(g);b.async=1;b.src="//www.gstatic.com/wcm/loader.js";d=e.getElementsByTagName(g)[0];d.parentNode.insertBefore(b,d);a._googWcmGet=function(b,d,e){a[c](2,b,h,d,null,new Date,e)}})(window,document,"_googWcmImpl","_googWcmAk","script");
</script>
</head>
			...
			if ( $notificationpanel_switch  || isset( $wp_customize ) ) {
				...
				<div class='notification-panel' data-stateonload='<?php echo $notificationpanel_switch; ?>' data-uniquehash='<?php echo $npanel_unique_cookie_key;?>'>
                    ...
                    <span class='notification-panel__content'>
						<span class='notification-panel__message'>
							<?php
								...
								echo "<span class='notification-panel__message-text'>".$notificationpanel_message."&nbsp;&nbsp;&nbsp;<i class='fa-icon-angle-right notification-panel__cta-icon'></i></span>";
							?>
						</span>
					...
					<?php if ( 4 < strlen($notificationpanel_buttonurl)  ) { ?>
						...
						<a style="cursor:pointer;" class='notification-panel__cta-link click_togg-menu_header'></a>
