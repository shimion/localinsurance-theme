	...
	if ( $calltoaction_switch || isset($wp_customize) ) {
		...
		<section class='calltoaction-area' data-stateonload='<?php echo $calltoaction_switch; ?>'>
			<span class='calltoaction-area__content'>
				<?php
					if(is_page_template('page-secondary-spanish.php') || is_page_template('page-spanish.php')){ echo "<span style='font-size:29px;'>Llame 1-877-709-8101 para una cotizacion gratuita o haga clic aqui para una cotizacion</span> &nbsp;&nbsp;&nbsp;<i class='fa-icon-angle-right calltoaction-area__cta-icon'></i>";	}else{echo "Call 1-877-709-8101 for a FREE Quote! &nbsp;&nbsp;&nbsp;<i class='fa-icon-angle-right calltoaction-area__cta-icon'></i>";}
				?>
			</span>
            ...
            <div class="menu-quoto show_togg-menu_footer" style="display:none;">
