...
require_once ( $theme_dir . '/contact_function.php' );           // 19
...
function form_2( $atts){
	$output =  '';
	$output .=  '
	<form id="demoForm" method="get" action="" class="bbq">
				<div id="fieldWrapper">
				<div class="step" id="first">';
					...
					<input type="hidden" name="Provider" value="LockInsuranceWeb">
					<input type="hidden" name="title_post" value="'.get_the_title().'">
					<input type="hidden" name="thank_you" value="'.CFS()->get('thank_you_page').'">
					
					<input type="hidden" name="Client" value="LockInsurance">
					
					<input type="hidden" name="CampaignId" value="XX">
				...
				$output .=  '<div id="demoNavigation"> 							
					...
					<input class="navigation_button" id="next" value="Next" type="submit" name="submit_form" />
				</div>
...
/*	$fname = $_GET['fname'];
	$lname = $_GET['lname'];
	$email = $_GET['email'];
	$email = $_GET['staddress'];
*/	


	//$check_lead = $wpdb->get_var('SELECT COUNT(*) FROM '.$table_name.' WHERE email LIKE '.$_GET['email'].' AND type LIKE '.$_GET['title_post'].'');
	//if($check_lead== NULL){
		//wp_redirect(); exit;
		//}else{
			$wpdb->insert( $table_name, array( 
				  ...
				  'Zip' => $_GET['Zip'],
				  'phone' => $_GET['phone'],
				  'eve_phone' => $_GET['eve_phone'],
				  'date_of_birth' => $_GET['date_of_birth'],
				  'medication' => $_GET['medication'],
				  'term_option' => $_GET['term_option'],
				  'term_coverag_amount' => $_GET['term_coverag_amount'],
				  'Exterior_Wall_Type' => $_GET['Exterior_Wall_Type'],
				  'property_type' => $_GET['property_type'],
				  'year_build' => $_GET['year_build'],
				  'squar_footge' => $_GET['squar_footge'],
				  'property_country' => $_GET['property_country'],
				  'swimming_pool' => $_GET['swimming_pool'],
				  'driver_first_name1' => $_GET['1driver_first_name'],
				  'driver_last_name1' => $_GET['1driver_last_name'],
				  'driver_birthdate1' => $_GET['1st_driver_birthdate'],
				  'driver_maritual_statues1' => $_GET['1driver_maritual_statues'],
				  'driver_1st_violation_description1' => $_GET['1st_driver_1st_violation_description'],
				  'driver_first_name2' => $_GET['2driver_first_name'],
				  'driver_last_name2' => $_GET['2driver_last_name'],
				  'driver_birthdate2' => $_GET['2nd_driver_birthdate'],
				  'driver_maritual_statues2' => $_GET['2driver_maritual_statues'],
				  'driver_1nd_violation_description2' => $_GET['2nd_driver_1nd_violation_description'],
				  'driver_first_name3' => $_GET['3driver_first_name'],
				  'driver_last_name3' => $_GET['3driver_last_name'],
				  'driver_birthdate3' => $_GET['3nd_driver_birthdate'],
				  'driver_maritual_statues3' => $_GET['3driver_maritual_statues'],
				  'driver_1nd_violation_description3' => $_GET['3rd_driver_1nd_violation_description'],
				  'Vehicle_year1' => $_GET['1_Vehicle_year'],
				  'Vehicle_Make1' => $_GET['1_Vehicle_Make'],
				  'Vehicle_Model1' => $_GET['1_Vehicle_Model'],
				  'Vehicle_Deductible1' => $_GET['1_Vehicle_Deductible'],
				  'Vehicle_year2' => $_GET['2_Vehicle_year'],
				  'Vehicle_Make2' => $_GET['2_Vehicle_Make'],
				  'Vehicle_Model2' => $_GET['2_Vehicle_Model'],
				  'Vehicle_Deductible2' => $_GET['2_Vehicle_Deductible'],
				  'Vehicle_year3' => $_GET['3_Vehicle_year'],
				  'Vehicle_Make3' => $_GET['3_Vehicle_Make'],
				  'Vehicle_Model3' => $_GET['3_Vehicle_Model'],
				  'What_are_your_current_liability_limits' => $_GET['What_are_your_current_liability_limits'],
				  'Current_Resident_Status' => $_GET['Current_Resident_Status'],
				  'Requested_Policy_Start_Date' => $_GET['Requested_Policy_Start_Date'],
				  'Foundation_Type' => $_GET['Foundation_Type'],
				  'Roof_Type' => $_GET['Roof_Type'],
				  'Property_Extras' => $_GET['Property_Extras'],
				  'Heating_Type' => $_GET['Heating_Type'],
				  'Garage_Type' => $_GET['Garage_Type'],
				  'Bathrooms' => $_GET['Bathrooms'],
				  'Additional_Comments' => $_GET['Additional_Comments'],
				  'square_ft' => $_GET['square_ft'],
				  'Promotion_Code' => $_GET['Promotion_Code'],
				  'dogs' => $_GET['dogs'],
				  'hear_about_us' => $_GET['hear_about_us'],
				  'method_to_contuct' => $_GET['method_to_contuct'],
				  'type' => $_GET['title_post'],
				  'insurance_experience' => $_GET['insurance_experience'],
				  'think_did_best' => $_GET['think_did_best'],
				  'vote_counts' => $_GET['vote_counts'],
				  'like_a_quote' => $_GET['like_a_quote'],
				  'date_lead' => $_GET['date_lead'],
				 ), 
				 array( 
				  '%s', 
				  '%s' 
				 ) );
	//echo json_encode(array('success'=> true, 'message'=>$checkout_error),  JSON_HEX_QUOT | JSON_HEX_TAG);
	wp_redirect('https://secure.velocify.com/Import.aspx?Provider=LockInsuranceWeb&Client=LockInsurance&CampaignId=43&URL='.$_GET['thank_you'].'&fname='.$_GET['fname'].'&lname='.$_GET['lname'].'&email='.urlencode($_GET['email']).'&staddress='.$_GET['staddress'].'&city='.$_GET['city'].'&state='.$_GET['state'].'&Zip='.$_GET['Zip'].'&phone='.$_GET['phone'].'&eve_phone='.$_GET['eve_phone'].'&date_of_birth='.$_GET['date_of_birth'].'&medication='.$_GET['medication'].'&term_option='.$_GET['term_option'].'&term_coverag_amount='.$_GET['term_coverag_amount'].'&Exterior_Wall_Type='.$_GET['Exterior_Wall_Type'].'&property_type='.$_GET['property_type'].'&year_build='.$_GET['year_build'].'&squar_footge='.$_GET['squar_footge'].'&property_country='.$_GET['property_country'].'&swimming_pool='.$_GET['swimming_pool'].'&1driver_first_name='.$_GET['1driver_first_name'].'&1driver_last_name='.$_GET['1driver_last_name'].'&1st_driver_birthdate='.$_GET['1st_driver_birthdate'].'&1driver_maritual_statues='.$_GET['1driver_maritual_statues'].'&2driver_first_name='.$_GET['2driver_first_name'].'&2driver_last_name='.$_GET['2driver_last_name'].'&2nd_driver_birthdate='.$_GET['2nd_driver_birthdate'].'&2driver_maritual_statues='.$_GET['2driver_maritual_statues'].'&3driver_first_name='.$_GET['3driver_first_name'].'&3driver_last_name='.$_GET['3driver_last_name'].'&3nd_driver_birthdate='.$_GET['3nd_driver_birthdate'].'&3driver_maritual_statues='.$_GET['3driver_maritual_statues'].'&accidents='.$_GET['accidents'].'&accidents2='.$_GET['accidents2'].'&accidents3='.$_GET['accidents3'].'&1_Vehicle_year='.$_GET['1_Vehicle_year'].'&1_Vehicle_Make='.$_GET['1_Vehicle_Make'].'&1_Vehicle_Model='.$_GET['1_Vehicle_Model'].'&1_Vehicle_Deductible='.$_GET['1_Vehicle_Deductible'].'&2_Vehicle_year='.$_GET['2_Vehicle_year'].'&2_Vehicle_Make='.$_GET['2_Vehicle_Make'].'&2_Vehicle_Model='.$_GET['2_Vehicle_Model'].'&2_Vehicle_Deductible='.$_GET['2_Vehicle_Deductible'].'&3_Vehicle_year='.$_GET['3_Vehicle_year'].'&3_Vehicle_Make='.$_GET['3_Vehicle_Make'].'&3_Vehicle_Model='.$_GET['3_Vehicle_Model'].'&3_Vehicle_Deductible='.$_GET['3_Vehicle_Deductible'].'&What_are_your_current_liability_limits='.$_GET['What_are_your_current_liability_limits'].'&Current_Resident_Status='.$_GET['Current_Resident_Status'].'&Design_Type='.$_GET['Design_Type'].'&Requested_Policy_Start_Date='.$_GET['Requested_Policy_Start_Date'].'&Square_Footage='.$_GET['Square_Footage'].'&Number_of_Stories='.$_GET['Number_of_Stories'].'&Foundation_Type='.$_GET['Foundation_Type'].'&Roof_Type='.$_GET['Roof_Type'].'&Property_Extras='.$_GET['Property_Extras'].'&Heating_Type='.$_GET['Heating_Type'].'&Additional_Comments='.$_GET['Additional_Comments'].'&Garage_Type='.$_GET['Garage_Type'].'&Bathrooms='.$_GET['Bathrooms'].'&Promotion_Code='.$_GET['Promotion_Code'].'&Additional_Comments='.$_GET['Additional_Comments'].'&hear_about_us='.$_GET['hear_about_us'].'&dogs='.$_GET['dogs'].'&insurance_experience='.$_GET['insurance_experience'].'&think_did_best='.$_GET['think_did_best'].'&vote_counts='.$_GET['vote_counts'].'&like_a_quote='.$_GET['like_a_quote'].''); exit;
...
function form( $atts){
	...
	<form id="demoForm" method="get" action="" class="bbq">
				...
				<div class="step" id="first">';
					...
					$output .=  '<input type="hidden" name="date_lead" value="'.$mydate['year'].'-'.$mydate['mon'].'-'.$mydate['mday'].'">';
					
					$output .=  '<input type="hidden" name="title_post" value="'.get_the_title().'">
					<input type="hidden" name="thank_you" value="'.CFS()->get('thank_you_page').'">
					<input type="hidden" name="Client" value="LockInsurance">
