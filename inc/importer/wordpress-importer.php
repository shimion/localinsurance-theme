<?php
/*
WordPress Importer plugin Class
 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
class pvt_WP_Import extends WP_Importer {
	...
	function pvt_WP_Import() { /* nothing */ }
...
<?php
	...
	function process_posts() {
		...
		foreach ( $this->posts as $post ) {
			...
			$obj = $wp_post_types['lbmn_archive'];
